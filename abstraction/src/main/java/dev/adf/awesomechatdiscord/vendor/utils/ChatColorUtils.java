...
public class ChatColorUtils {
    ...
    public static String filterIllegalColorCodes(String string) {
        return filterIllegalColorCodes(string, dev.adf.awesomechatdiscord.vendor.IC.version.isLegacyRGB());
    }
    ...
    public static String translateAlternateColorCodes(char code, String text) {
        return translateAlternateColorCodes(code, text, IC.version.isLegacyRGB(), IC.rgbTags, IC.additionalRGBFormats);
    }
