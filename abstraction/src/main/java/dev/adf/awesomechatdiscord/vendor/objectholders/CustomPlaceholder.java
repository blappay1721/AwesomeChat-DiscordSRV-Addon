...
public class CustomPlaceholder extends ICPlaceholder {
    ...
    /**
     * AwesomeChat lets a custom trigger name any permission node it likes, rather
     * than deriving one from the trigger key.
     */
    public CustomPlaceholder(String key, ParsePlayer parsePlayer, Pattern keyword, boolean parseKeyword, long cooldown, CustomPlaceholderHoverEvent hover, CustomPlaceholderClickEvent click, CustomPlaceholderReplaceText replace, String name, Component description, String permission) {
        this(key, parsePlayer, keyword, parseKeyword, cooldown, hover, click, replace, name, description);
