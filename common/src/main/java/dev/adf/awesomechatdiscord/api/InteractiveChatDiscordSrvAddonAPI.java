...
package dev.adf.awesomechatdiscord.api;
...
public class InteractiveChatDiscordSrvAddonAPI {
    ...
    public static boolean isReady() {
        return AwesomeChatDiscordAddon.isReady;
    }
    ...
    public static ResourceManager getCurrentResourceManager() {
        return AwesomeChatDiscordAddon.plugin.isResourceManagerReady() ? AwesomeChatDiscordAddon.plugin.getResourceManager() : null;
    }
