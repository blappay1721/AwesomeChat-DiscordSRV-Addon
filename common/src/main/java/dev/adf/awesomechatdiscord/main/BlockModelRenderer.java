...
import dev.adf.awesomechatdiscord.utils.TintUtils;
    ...
    public void loadResources() {
        ...
        try {
            ...
            try {
                ...
                yaml.load(Files.newInputStream(Paths.get("AwesomeChatDiscordAddon/config.yml")));
            ...
            try {
                ...
                sources.add(ResourcePackSource.ofDefault("Default", new File("AwesomeChatDiscordAddon/built-in", "Default"), ResourcePackType.BUILT_IN));
                for (String resourceName : resourceOrder) {
                    File resourcePackFile = new File("AwesomeChatDiscordAddon/resourcepacks/" + resourceName);
                    sources.add(ResourcePackSource.ofCustom(resourceName, new File("AwesomeChatDiscordAddon/resourcepacks/" + resourceName), ResourcePackType.LOCAL));
                }
