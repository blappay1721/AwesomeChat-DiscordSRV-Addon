...
public class DiscordReadyEvents {
    ...
    public void ready() {
        ...
        DiscordSRV discordsrv = AwesomeChatDiscordAddon.discordsrv;
        ...
        Bukkit.getPluginManager().registerEvents(discordCommands, AwesomeChatDiscordAddon.plugin);
            ...
            if (channelId != null) {
                try {
                    ...
                    if (channel != null) {
                        ...
                        for (Permission permission : AwesomeChatDiscordAddon.requiredPermissions) {
                            if (!self.hasPermission(channel, permission)) {
                                Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "[AwesomeChatDiscordAddon] DiscordSRV Bot is missing the \"" + permission.getName() + "\" permission in the channel \"" + channel.getName() + "\" (Id: " + channel.getId() + ")");
                            }
                        }
                    }
                } catch (Exception e) {
