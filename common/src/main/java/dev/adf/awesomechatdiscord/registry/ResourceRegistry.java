...
package dev.adf.awesomechatdiscord.registry;
...
public class ResourceRegistry {
    ...
    static {
        ...
        try {
            ...
            resourcePackVersion = dev.adf.awesomechatdiscord.utils.ResourcePackUtils.getServerResourcePackVersion();
            itemTextureLocation = dev.adf.awesomechatdiscord.vendor.IC.version.isLegacy() ? "minecraft:items/" : "minecraft:item/";
            blockTextureLocation = dev.adf.awesomechatdiscord.vendor.IC.version.isLegacy() ? "minecraft:blocks/" : "minecraft:block/";
