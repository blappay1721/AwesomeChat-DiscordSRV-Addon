...
package dev.adf.awesomechatdiscord.libs;
...
public abstract class URLClassLoaderAccess {
    ...
    private static void throwError(Throwable cause) throws UnsupportedOperationException {
        throw new UnsupportedOperationException("AwesomeChatDiscordAddon is unable to inject into the plugin URLClassLoader.\n" +
